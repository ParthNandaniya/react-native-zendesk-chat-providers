...
public class ZendeskChatProvidersModule extends ReactContextBaseJavaModule {
    ...
    public ZendeskChatProvidersModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void observeAccountState(Promise promise) {
